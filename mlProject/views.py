...
model_nn = tf.keras.models.load_model(
    "mlProject/models/feed_forward_neural_networks.h5"
)
model_rf = joblib.load("mlProject/models/random_forest_model.pkl")
model_dt = joblib.load("mlProject/models/decision_tree_model.pkl")
model_lr = joblib.load("mlProject/models/logistic_regression_model.pkl")
...
def predict_visa_status(request):
    ...
    try:
        ...
        student_merit_score = float(
            gpa * 10 + english_proficiency * 0.3 + research_publications * 10
        )
